...
from instruments.mixins import AbstractRelatedInstrument
...
from wagtail.core.models import PageRevision# Orderable, Page, 
...
class RUBIONUser (_RUBIONUserModelDefinition, ActiveInactiveMixin ):
    '''
    ...
    def validate ( self, request, user, username ):
        ...
        # @TODO maybe log in the user now?

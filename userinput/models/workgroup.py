...
from ugc.models import UserGeneratedPage2, UGCCreatePage2, UGCContainer2

from userinput.mixins import ActiveInactiveMixin
from userinput.models.containers import MemberContainer, ProjectContainer
from userinput.models.project import Project
...
class WorkGroupContainer ( UGCContainer2 ):
    ...
    subpage_types = [ 'userinput.WorkGroup', UGCCreatePage2 ]
